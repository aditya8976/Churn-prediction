      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="glass-card p-6 rounded-2xl border border-rose-500/20 bg-rose-950/10">
            ...
            <div className="text-3xl font-extrabold text-white mb-1">5% to 7%</div>
            <h3 className="text-sm font-semibold text-rose-300 mb-2">Average Monthly SaaS Churn</h3>
          ...
          <div className="glass-card p-6 rounded-2xl border border-amber-500/20 bg-amber-950/10">
            ...
            <div className="text-3xl font-extrabold text-white mb-1">5x Costlier</div>
            <h3 className="text-sm font-semibold text-amber-300 mb-2">Acquisition vs Retention</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="glass-card p-6 rounded-2xl border border-emerald-500/20 bg-emerald-950/10">
            ...
            <div className="text-3xl font-extrabold text-white mb-1">68% Preventable</div>
            <h3 className="text-sm font-semibold text-emerald-300 mb-2">Early Warning Intervention</h3>
            <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="glass-card p-8 sm:p-10 rounded-3xl border border-indigo-500/30 bg-gradient-to-br from-indigo-950/40 via-slate-900 to-purple-950/40">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="space-y-5">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="px-6 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold shadow-lg shadow-indigo-600/30 flex items-center space-x-2 transition-all"
                >
            ...
            <div className="glass-card p-6 rounded-2xl border border-slate-700 space-y-4">
              <div className="flex items-center justify-between text-xs border-b border-slate-800 pb-3">
                <span className="font-semibold text-slate-300">Live Model Inference Workflow</span>
              ...
              <div className="space-y-3 text-xs">
                <div className="flex items-center justify-between p-3 rounded-xl bg-slate-900/80 border border-slate-800">
                  ...
                  <span className="text-indigo-300 font-mono">Last Login: 42 days, Watch: 0.15h/day</span>
                </div>
                <div className="flex items-center justify-between p-3 rounded-xl bg-slate-900/80 border border-slate-800">
                  <span className="text-slate-400">Model Output:</span>
                  <span className="text-rose-400 font-bold font-mono">99.97% Churn Risk (HIGH)</span>
                </div>
                <div className="p-3 rounded-xl bg-rose-950/20 border border-rose-500/30 text-rose-200 text-[11px] leading-relaxed">
